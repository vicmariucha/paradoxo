...
export const SERVICE_DETAILS: Record<string, ServiceDetail> = {
  impressos: {
    ...
    faq: [
      ...
      { q: "Como funcionam os kits de onboarding para setores de Recursos Humanos (RH)?", a: "Os kits de onboarding da Paradoxo são materiais impressos personalizados, como pastas de boas-vindas e manuais de cultura corporativa com acabamento premium, usados por departamentos de RH para fortalecer a integração e valorização de novos colaboradores." },
      { q: "Quais impressos são indicados para startups em fase de captação de investimento?", a: "Para startups, recomendamos pastas de pitch comercial, decks impressos em papéis especiais e kits de apresentação corporativa, transmitindo solidez institucional e profissionalismo diante de investidores e parceiros estratégicos." },
      { q: "Quais impressos de luxo são usados por concessionárias na entrega de veículos?", a: "Concessionárias utilizam pastas de entrega de chaves e manuais com acabamento soft touch, envelopes porta-documentos personalizados e catálogos de veículos, reforçando a percepção de valor do produto entregue ao cliente." },
      { q: "Que tipo de material gráfico institui financeiras utilizam para relatórios e propostas?", a: "Instituições financeiras utilizam pastas corporativas para lâminas de fundos e relatórios de investimento, além de envelopes personalizados de segurança, transmitindo confiança, sigilo e solidez patrimonial ao cliente." },
      { q: "Quais impressos são recomendados para construtoras e incorporadoras em lançamentos imobiliários?", a: "Construtoras e incorporadoras utilizam pastas de fechamento de contrato, envelopes porta-escrituras e catálogos de empreendimentos (lookbooks) com acabamento nobre, reforçando exclusividade e alto padrão nos lançamentos." },
      { q: "Quais materiais impressos são usados por hotéis e resorts para experiência do hóspede?", a: "Hotéis e resorts utilizam pastas de conciergerie, diretórios de quarto em papéis texturizados e envelopes personalizados de boas-vindas, criando uma experiência sensorial de acolhimento e sofisticação para o hóspede." },
      { q: "Como projetistas e designers industriais podem apresentar seus portfólios com mais autoridade?", a: "Projetistas e designers industriais utilizam pastas de apresentação técnica em grande formato e catálogos de especificações com acabamento nobre, comprovando rigor técnico e qualidade estética diante de clientes e parceiros." },
      { q: "Quais impressos de luxo são indicados para clínicas, hospitais e laboratórios?", a: "Clínicas, hospitais e laboratórios utilizam pastas para entrega de laudos e exames, envelopes de receitas personalizados e guias de tratamento com acabamento premium, transmitindo confiança clínica e cuidado ao paciente." },
      { q: "Que tipo de papelaria é indicada para escritórios de advocacia?", a: "Escritórios de advocacia utilizam pastas para contratos em papel nobre, envelopes ofício com fechamento elegante e papel timbrado premium, reforçando tradição, sigilo e autoridade jurídica." },
      { q: "Quais impressos institucionais são usados por escritórios de arquitetura e engenharia?", a: "Escritórios de arquitetura e engenharia utilizam pastas de entrega de projetos executivos e catálogos de portfólio encadernados com acabamento especial, demonstrando refinamento estético e atenção aos detalhes." },
      { q: "Quais materiais gráficos o agronegócio utiliza em negociações e feiras?", a: "Empresas do agronegócio utilizam pastas de representação comercial, catálogos de insumos e relatórios institucionais impressos, reforçando solidez de mercado e credibilidade em negociações e feiras do setor." },
      { q: "Quais impressos são recomendados para escritórios de contabilidade?", a: "Escritórios de contabilidade utilizam pastas organizadoras para relatórios fiscais e envelopes personalizados de correspondência oficial, transmitindo segurança, organização e profissionalismo institucional." },
      { q: "Quais materiais gráficos são usados por instituições de ensino privadas?", a: "Colégios, faculdades e universidades privadas utilizam kits de boas-vindas, pastas de matrícula e diplomas com acabamento nobre, valorizando a experiência acadêmica e reforçando a excelência institucional." },
    ],
  },
  marketing: {
    slug: "marketing",
