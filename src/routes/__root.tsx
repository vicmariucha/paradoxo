...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PARADOXO" },
      { name: "description", content: "Soluções empresariais de alto padrão. Impressos premium, marketing e consultoria para clientes exigentes." },
      { name: "author", content: "PARADOXO" },
      { property: "og:title", content: "PARADOXO" },
      { property: "og:description", content: "Soluções empresariais de alto padrão. Impressos premium, marketing e consultoria para clientes exigentes." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@paradoxo" },
      { name: "twitter:title", content: "PARADOXO" },
      { name: "twitter:description", content: "Soluções empresariais de alto padrão. Impressos premium, marketing e consultoria para clientes exigentes." },
