    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          alternateName: ["Paradoxo", "Suporte Paradoxo"],
          url: "https://www.suporteparadoxo.com.br/",
          description:
            "Empresa especializada em impressos corporativos de luxo, papelaria executiva de alto padrão, pastas comerciais, envelopes personalizados, catálogos premium, kits de apresentação, branding, suporte estratégico e finanças.",
          knowsAbout: [
            "Impressos de Luxo",
            ...
            "Suporte Estratégico",
            "Finanças e Viabilidade Financeira",
          ],
          serviceType: [
            "Produção Gráfica de Alto Padrão",
            "Impressos de Autoridade Corporativa",
            "Pastas Comerciais Personalizadas",
            "Envelopes Corporativos Personalizados",
            "Catálogos e Materiais Institucionais Premium",
            "Kits de Apresentação e Fechamento de Contratos",
            "Kits de Onboarding para Recursos Humanos",
            "Consultoria de Branding e Posicionamento",
            "Suporte Estratégico e Financeiro",
          ],
          audience: {
            "@type": "Audience",
            audienceType: [
